                   ...
                   @foreach($sub_category as $cat)
                       <tr>
                          ...
                          <td>
                            ...
                            <input type="checkbox" class="subcategorystatus btn btn-success" rel="{{$cat->id}}" data-toggle="toggle"
                          ...
                          <td>
                              <a href="#" data-category="{{$cat->category_id}}" data-sub_category="{{$cat->sub_category}}" data-id="{{$cat->id}}" data-toggle="modal" data-target="#exampleModaledit"><i class="fa fa-edit"></i></a>
                              &nbsp &nbsp
                              <a href="{{route('sub_category.delete',$cat->id)}}"><i class="fa fa-trash" style="color:red"></i></a>
                          </td>
                       </tr>
                 ...
                 <div class="modal-dialog" role="document">
                   <div class="modal-content">
                     <div class="modal-header">
                       <h4 class="modal-title" id="exampleModalLabel">Sub Category</h4>
                        ...
                        <form action="{{route('sub_category.store')}}" method="post">
                          @csrf
                                  ...
                                  <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="sub_category" name="sub_category" placeholder="Enter Sub Category">
                                 </div>
                      ...
                      <form action="" method="post" id="editForm">
                       {{ csrf_field() }}
                        {{method_field('put')}}
                                 ...
                                 <div class="form-group">
                                    <label> Sub Category</label>
                                    <input type="text" class="form-control"  id="sub_category" name="sub_category" placeholder="Enter Main Category">
                                 </div>
...
modal.find('.modal-body #editForm').prop('action',`{{url('sub_category/update/${id}')}}`);
})
 </script>
