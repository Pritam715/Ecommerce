                                        ...
                                        <div id="demo-1" class="simpleLens-gallery-container">
                                            <div class="simpleLens-container">
                                                <div class="simpleLens-big-image-container"><a
                                                        data-lens-image="{{ asset('Images/Product/' . $details->product_image) }}"
                                                        class="simpleLens-lens-image"><img
                                                            src="{{ asset('Images/Product/' . $details->product_image) }}"
                                                            width="100%" class="simpleLens-big-image"></a></div>
                                            </div>

                                            <div class="simpleLens-thumbnails-container">
                                                <a data-big-image="{{ asset('Images/Product/' . $details->product_image) }}"
                                                    data-lens-image="{{ asset('Images/Product/' . $details->product_image) }}"
                                                ...
                                                @foreach ($images as $img)
                                                    ...
                                                    <a data-big-image="{{ asset('Images/Product/' . $img->image) }}"
                                                        data-lens-image="{{ asset('Images/Product/' . $img->image) }}"
                                                        class="simpleLens-thumbnail-wrapper" href="#">
                                ...
                                <div class="col-md-7 col-sm-7 col-xs-12">
                                    <form method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="aa-product-view-content">
                                            ...
                                            <input type="hidden" class="form-control" value="{{ $details->id }}"
                                                name="product_id" id="product_id">
                                            <input type="hidden" class="form-control"
                                                value="{{ $details->product_name }}" name="product_name"
                                                id="product_name">
                                            <input type="hidden" class="form-control"
                                                value="{{ $details->product_code }}" name="product_code"
                                                id="product_code">
                                            <input type="hidden" class="form-control"
                                                value="{{ $details->product_price }}" name="product_price"
                                                id="product_price">
                                            <input type="hidden" class="form-control"
                                                value="{{ $details->product_image }}" name="product_image"
                                                id="product_image">
                                            <input type="hidden" class="form-control" name="product_price" id="price">
                                            <div class="aa-price-block">
                                                <span class="aa-product-view-price"
                                                    id="price">{{ $details->product_price }}</span>
                                                <p class="aa-product-avilability">Avilability: <span>In stock</span></p>
                                            </div>
                                            <p style="padding:20px;background-color:rgb(241, 236, 236)">
                                                {{ $details->short_description }}</p>


                                            <!--color-->
                                            <p>Select Color: <span style="color:red;margin-left:10px"
                                                    id="colorboxid_error_msg"></span></p>
                                            <div class="aa-color-tag">

                                                @foreach ($attributes->unique('color') as $attr)

                                                    <label><input type="radio" id="colorboxid" class="color"
                                                            value="{{ $attr->color }}" name="color"><span
                                                            style="background-color:{{ $attr->color }}"></span></label>

                                                @endforeach()
                                            </div>
                                            <!--size-->
                                            <p>Available Size: <span style="color:red;margin-left:10px"
                                                    id="checkboxid_error_msg"></span></p>
                             ...
                             <label><input type="radio"   value="XXL" name="size"><span>XXL</span></label>-->
                                            ...
                                            <div class="aa-prod-view-bottom">
                                                <button type="button" name="cart" value="cart"
                                                    class="aa-add-to-cart-btn cart">Add To Cart</button>
                                                <button type="button" name="wishlist" value="wishlist"
                                                    class="aa-add-to-cart-btn wishlist">Add To WishList</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        for (var i = 0; i < data.length; i++) {
                            ...
                            op += '<label><input type="radio" id="checkboxid"  value="' + data[
                                    i].size + '" name="size"><span>' + data[i].size +
                                '</span></label> <label><input type="hidden" id="latestproduct_price"  value="' +
                                data[i].price +
                                '" name="price"></label> <label><input type="hidden" id="sku"  value="' +
                                data[i].sku + '" name="sku"></label>';
        ...
        $(document).ready(function() {
            $('.cart').click(function() {
                ...
                if (!($('#checkboxid').is(':checked'))) {
                    ...
                    setTimeout(function() {
                        $("#checkboxid_error_msg").fadeOut('slow');
                    }, 2000);
                ...
                if (!($('#colorboxid').is(':checked'))) {
                    ...
                    setTimeout(function() {
                        $("#colorboxid_error_msg").fadeOut('slow');
                    }, 2000);
